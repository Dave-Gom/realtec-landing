...
export const es: Translations = {
  ...
  introduction: {
    ...
    description:
      "Realtec es la desarrolladora del Grupo Tecnoedil, creada para transformar oportunidades en proyectos estratégicos con visión de largo plazo. \n\nNos especializamos en desarrollos industriales, corporativos y de usos mixtos, con alcance e impacto nacional. En cada proyecto asumimos un compromiso real, alineando intereses y asegurando resultados que generan valor para los usuarios y para el país.",
    teamButton: "Nuestro Equipo",
  },
  counter: {
    investment: {
      primary: "USD 18 millones",
      secondary: "Inversión en desarrollo",
    },
    projects: {
      primary: "3 Proyectos",
      secondary: "Pipeline de desarrollo",
    },
    surface: {
      primary: "20.000 m²",
      secondary: "Superficie en desarrollo",
    },
  },
  projects: {
    ...
    dotSacramento: {
      ...
      location: "Sacramento 2265, Asunción",
      status: "Entregado",
    },
    industrialPark: {
  ...
  choseUs: {
    title: "¿Por qué invertir con Realtec?",
    description:
  ...
  ourTeam: {
    ...
    members: {
      ...
      sebastianKunzle: {
        name: "Sebastian Kunzle",
        position: "Coordinador de Proyectos",
        description:
          "Ingeniero Civil con amplia experiencia en adquisiciones y desarrollo inmobiliario en Florida, liderando procesos de negociación y cierre de proyectos que combinan rigor técnico con visión estratégica, asegurando inversiones sólidas y generadoras de valor.",
      },
      lucasAcosta: {
        name: "Lucas Acosta",
        position: "Coordinador de Proyectos",
      ...
      sarahStadler: {
        ...
        description:
          "Sarah potencia la comunicación de Realtec y sus proyectos con creatividad y organización. Su entusiasmo por aprender, la observación de tendencias y el análisis de la competencia contribuyen a consolidar la estrategia de marketing de la empresa.",
      },
    },
  },
  services: {
    title: "Gestión de Desarrollos Inmobiliarios",
    subtitle:
      "Transformamos oportunidades en proyectos rentables, con estrategia, foco y visión.",
    cards: {
      transformation: "Transformación con Valor",
      strategy: "Estrategia Integral",
      execution: "Ejecución Profesional",
      differentiation: "Diferenciación Real",
    },
  },
  partners: {
